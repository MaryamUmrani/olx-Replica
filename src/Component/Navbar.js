...
import "./Navbar.css";
import { FaSistrix, FaShoppingBasket } from "react-icons/fa";
  ...
  return (
    <nav className="container">
      ...
      <div className="input-container">
        ...
        <FaSistrix className="nav__search-icon" />
      </div>

      {/* links1 */}
      <Link to={!user && "/login"} className="main__link">
      ...
      <Link to="/checkout" className="main__link">
        <div className="shooping_basket">
          <FaShoppingBasket className="main__icons" />
